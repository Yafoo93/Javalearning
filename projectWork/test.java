...
public class test {
    ...
    private static void numberGuesser() {
        ...
        resultLabel.setBounds(50, 180, 2000, 50);
        ...
        cancelButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // Restart the game by re-initializing variables and labels

                //secretNumber = ThreadLocalRandom.current().nextInt(lowerNumber, upperNumber + 1);
